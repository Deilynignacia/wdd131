...
// Using document.lastModified which provides the date of the last modification to the current document
...
const temples = [
    ...
    },
    {
        ...
        dedicated: "Not yet dedicated (Under Construction)",
        area: 24700,
        imageUrl:
...
function createTempleCard(filteredTemples) {
    ...
    filteredTemples.forEach(temple => {
        ...
        area.innerHTML = `<span class="label">Size:</span> ${temple.area.toLocaleString()} sq ft`; // Format area with commas
